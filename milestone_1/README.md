...
For this project, we use the [Food Nutrition Dataset]( https://www.kaggle.com/datasets/utsavdey1410/food-nutrition-dataset) available on Kaggle.
...
Our sources of inspiration can be found on the following links
